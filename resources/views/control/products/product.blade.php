                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" action="@if(isset($item)){{route('postEditProduct')}}@else{{route('postAddProduct')}}@endif" role="form" name="@if(isset($item)){{'frm_product_edit'}}@else{{'frm_product_add'}}@endif" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <span ><strong>Loại dịch vụ</strong> </span>
                                <div class="radio">
                                    <label>
                                        <input name="IsHot" type="radio" class="colored-blue" @if(isset($item) && $item->IsHot ==0) {{'checked="checked"'}}  @endif value="0">
                                        <span class="text"> Du lịch</span>
                                    </label>
                                     <label>
                                        <input name="IsHot" type="radio" class="colored-danger" @if(isset($item) && $item->IsHot ==1) {{'checked="checked"'}} @endif  value="1">
                                        <span class="text"> Vận tải</span>
                                    </label>
                                </div>
                            </div>
                            <div class="col-md-4 ">
                        ...
                        <div class="row hidden">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Chọn hình ảnh đại diện" readonly>
                                </div>
                                <img id='img-upload'/>
                            </div>
                            <div class="col-md-6">
                                @if(isset($item)) <img src="Upload/product/{{$item->Img}}" style="height: 300px;margin-top: 50px;"  class="img-responsive" alt="Image"> @endif
