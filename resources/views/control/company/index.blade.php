                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12 profile-stats">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 inlinestats-col">
                            <i class="fa fa-phone"></i>@if (count($item) === 1 && $item->Phone!='')
                        {{ $item->Phone }}
                        @else
                        Hotline của công ty
                        @endif
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 inlinestats-col">
                            <i class="fa fa-calendar-o"></i> @if (count($item) === 1 && $item->created_at!='')
                        {{ $item->created_at }}
                        @else
                        Ngày tạo website công ty
                        @endif
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    <style>
                                        iframe{width: 100%;height: 100%;}
                                                            ...
                                                            @if (isset($item) && $item->Map!='')
                                         {!! $item->Map!!}
                                                            @else
                                                                Chưa có bản đồ công ty
                                                            @endif
                                        </div>
                                        <div>
                                ...
                                <form role="form" action="{{route('postCompany')}}" method="post" name='frm_company' accept-charset="utf-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Name" class="form-control" placeholder="Nhập tên công ty" value="@if (count($item) === 1 && $item->Name!=''){{ $item->Name }}@endif">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Email" class="form-control" value="@if (count($item) === 1 && $item->Email!=''){{ $item->Email }}@endif" placeholder="Nhập Email">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Phone" value="@if (count($item) === 1 && $item->Phone!=''){{ $item->Phone }}@endif" class="form-control" placeholder="Nhập Hotline">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Address" value="@if (count($item) === 1 && $item->Address!=''){{ $item->Address }}@endif" class="form-control" placeholder="Nhập Địa chỉ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Facebook" value="@if (count($item) === 1 && $item->Facebook!=''){{ $item->Facebook }}@endif" class="form-control" placeholder="Nhập Facebook">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Twitter" value="@if (count($item) === 1 && $item->Twitter!=''){{ $item->Twitter }}@endif" class="form-control" placeholder="Nhập Twitter">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Google" value="@if (count($item) === 1 && $item->Google!=''){{ $item->Google }}@endif" class="form-control" placeholder=" Nhập Google Plus">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Zalo" value="@if (count($item) === 1 && $item->Zalo!=''){{ $item->Zalo }}@endif" class="form-control" placeholder="Nhập Zalo">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Skype" value="@if (count($item) === 1 && $item->Skype!=''){{ $item->Skype }}@endif" class="form-control" placeholder="Nhập Skype">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" name="Viber" value="@if (count($item) === 1 && $item->Viber!=''){{ $item->Viber }}@endif" class="form-control" placeholder="Nhập Viber">
